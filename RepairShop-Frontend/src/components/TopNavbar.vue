  ...
  >
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav v-show="this.$root.$data.userType == 'Admin'">
        ...
        <b-nav-item to="modify_business_info"
          >Modify Business Information</b-nav-item
        >

        <b-nav-item-dropdown text="Holidays" right>
          <b-dropdown-item to="AddHoliday">Add</b-dropdown-item>
          <b-dropdown-item to="ViewDeleteHoliday"
            >View & Delete</b-dropdown-item
          >
        </b-nav-item-dropdown>

        <b-nav-item-dropdown text="Technicians" right>
          <b-dropdown-item to="technician_schedule_admin"
            >Schedules</b-dropdown-item
          >
          <b-dropdown-item to="cancelAppointmentAdmin"
            >Cancel Appointments</b-dropdown-item
          >
